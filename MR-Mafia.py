...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Mr Zihad Khan\x1b[0m\x1b[1;97m]
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m ADMIN   :  MAFI BOY \x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m GITHUB   : www.https://github.com/ZihadVau99 \x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m FACEBOOK  : https://www.facebook.com/profile.php?id=100061369206031\x1b[0m\x1b[1;97m]
...
def helpnote():
	...
	print("%s [=>] FOLLOW ME ON  FACEBOOK :)"%(G))

	#yahan nichy httsp sy hata kr apna github aproval link dalna

	subprocess.check_output(["am", "start", "https://github.com/ZihadVau99/approval.txt/blob/main/approoval.txt"])

	#yahan apni facebook id link dalna

	exit(" [=>] Facebook : https://www.facebook.com/profile.php?id=100061369206031")
...
def notice():
	...
	os.system('am start https://wa.me/+8801323478844?text=' )

	runtxt("\033[0;97m Key Approval Ke Liya Msg Krain >> %s%s"%(G,basesplit))

	runtxt("\033[0;97m Key Paid Mily Ge So Time Waster Block")

	time.sleep(5)

	os.system("xdg-open https://www.facebook.com/profile.php?id=100061369206031")

	subprocess.check_output(["am", "start", "https://wa.me/+8801323478844?text="])
...
class Main:
	...
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/ZihadVau99/approval.txt/blob/main/approoval.txt').text
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m MAFIA BY\x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version : 0.5\x1b[0m\x1b[1;97m] \033[1;37m 

 ───────────────────────────────────────────────────────×

\t\033[1;97m[\x1b[1;97m\x1b[1;41m ADMIN   : Mafia boy\x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m GITHUB   : https://github.com/NomiKing33 \x1b[0m\x1b[1;97m]
...
───────────────────────────────────────────────────────× 
    ...
    """)
		...
		print(" \t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook \x1b[0m\x1b[1;97m] \033[1;37m ")

		subprocess.check_output(["am", "start", "https://www.facebook.com/profile.php?id=100061369206031"])

		print("───────────────────────────────────────────────────────× ")

		print("%s [%s1%s]%s CRACK  FB IDZ 2009-11 {JUST NOW} %s(Devil-Clonning)"%(G,R,G,Y,B))
	...
	def fbtua(self):
		...
		try:
			...
			with ThreadPoolExecutor(max_workers=30) as coeg:
				...
				print("\033[0;92m[=×>]\033[0;92m NOTE : IDZ OPEN KRNA SE PEHLA ")

				print("\033[0;92m[=×>]\033[0;92m NOTE : FACEBOOK APP KA DATA CLEAR KRDNA " )
